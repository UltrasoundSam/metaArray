...
demo_data_out1 = DemoItem(title='Read PZFlex flxdato file.',
                          exe=data_out1_demo)
...
demo_plot1d.info = 'This demo will illustrate the usage of the plot1d \
function for metaArray.'
...
def plot2d_demo() -> str:
    ...
    filename = {repr(join(demo_dir, 'rel_amplitude.pickle'))}
...
demo_plot2d.info = 'This demo will illustrate the usage of the plot2d \
function for metaArray.'
...
whether or not to search the subdirectories.
    #**************************************************************************
    flist = file_list({repr(demo_dir)}, ext = 'flxhst', sub_dir = False)
    for fpath in flist: print('* ' + fpath)
    """
